...
# Use console backend if email credentials are not set (for development/testing)
...
if EMAIL_HOST_USER and EMAIL_HOST_PASSWORD:
    ...
    # Use console backend if credentials not configured (emails print to console/logs)

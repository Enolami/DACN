import { Plus, Heart, ListMusic, Mic2, Disc, ArrowUpDown, Filter, Search, MoreVertical, Play, Clock, User } from 'lucide-react';
...
interface LibraryPageProps {
  ...
  category?: 'playlists' | 'songs' | 'podcasts' | 'artists' | 'albums';
}
  ...
  const podcasts = [
    {
      ...
      episodes: 124,
      imageUrl: 'https://images.unsplash.com/photo-1485579149621-3123dd979885?w=300',
      isPrivate: false,
    },
    {
          ...
          <div className="grid grid-cols-5 gap-6">
            {podcasts.map((podcast, index) => (
              ...
              >
                ...
                <p className="text-gray-400 text-sm">{podcast.episodes} episodes</p>
              </motion.div>
            ))}
          </div>
        );

...
export function LibraryPage({ onNavigate, category = 'playlists' }: LibraryPageProps) {
  ...
  const likedSongs = [
    ...
    },
    {
      ...
      album: 'Retrograde',
      duration: '4:12',
      imageUrl: 'https://images.unsplash.com/photo-1744907529553-dc603ead4d4e?w=600',
      isLiked: true,
      isDownloaded: false,
      addedAt: '5 days ago',
    },
    {
      ...
      album: 'Night Drive',
      duration: '3:58',
      imageUrl: 'https://images.unsplash.com/photo-1662012061995-0cd4a7ef2d12?w=600',
      isLiked: true,
      isDownloaded: true,
      addedAt: '1 week ago',
    },
    {
      ...
      album: 'Ethereal',
      duration: '5:23',
      imageUrl: 'https://images.unsplash.com/photo-1582024959432-aee9b60ff4e8?w=600',
      isLiked: true,
      isDownloaded: false,
      addedAt: '1 week ago',
    },
